...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26/10/2023 às 16:08
...
INSERT INTO `produto` (`id_prod`, `nome_prod`, `preco_prod`, `quantidade_prod`, `descricao_prod`, `cod_distri`) VALUES
(1, 'Loção Hidratante Desodorante Corporal Cuide-se Bem Bubbaloo Morango 400ml', 66.00, 3, 'Descubra mais sobre\r\n\r\nLoção Hidratante Desodorante Corporal Cuide-se Bem Bubbaloo Morango 400ml\r\nTem dias que bate uma nostalgia e vontade de voltar no tempo, não é mesmo? Cuide-Se Bem Boticário e Bubbaloo se juntaram em uma edição limitada para fazer você reviver a fase mais divertida da vida, e ainda ter uma pele bem cuidada, hidratada e perfumada!\r\n\r\n\r\n\r\nLoção Hidratante Desodorante Corporal Cuide-se Bem Bubbaloo é um delicioso hidratante corporal que deixa sua pele macia, sedosa e perfumada com cheirinho inconfundível de Bubbaloo Morango.  Com 96% de ingredientes naturais, o Hidratante De', 1),
(2, 'Loção Hidratante Desodorante Corporal Cuide-se Bem Bubbaloo Morango 400ml', 66.45, 3, 'Descubra mais sobre\r\n\r\nLoção Hidratante Desodorante Corporal Cuide-se Bem Bubbaloo Morango 400ml\r\nTem dias que bate uma nostalgia e vontade de voltar no tempo, não é mesmo? Cuide-Se Bem Boticário e Bubbaloo se juntaram em uma edição limitada para fazer você reviver a fase mais divertida da vida, e ainda ter uma pele bem cuidada, hidratada e perfumada!\r\n\r\n\r\n\r\nLoção Hidratante Desodorante Corporal Cuide-se Bem Bubbaloo é um delicioso hidratante corporal que deixa sua pele macia, sedosa e perfumada com cheirinho inconfundível de Bubbaloo Morango.  Com 96% de ingredientes naturais, o Hidratante De', 1);
