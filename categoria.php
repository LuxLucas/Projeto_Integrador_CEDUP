...
<html lang="pt-br">
  <head>
    ...
    <title>BeauTIful - Administrar categoria</title>
  </head>
  <body>
  <header>
        <div class="container">
        ...
        <div class="container">
          <div class="mt-3">
            <nav aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Administrar Categoria</li>
                </ol>
            </nav>
          </div>
          <div class="my-4 d-block-flex">
            ...
            <div class="input-group mt-3">
              <button type="button" class="btn btn-sm btn-primary" id="btnCadastro" data-bs-toggle='modal' data-bs-target='#cadastro'>
...
<div class="modal fade" id="excluir" tabindex="-1" aria-labelledby="excluirLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <form action="php/Excluir/excluirCategoria" method="POST">
              <div class="modal-body text-center">
                <h2 class="fs-3 mb-3">ATENÇÃO</h2>
                <p class="fs-5 m-auto">Você deseja realmente <span class="text-danger">excluir</span> esta categoria ?(produtos com esta categoria serão desativados)</p>
...
<div class="modal fade" id="ativar" tabindex="-1" aria-labelledby="ativarLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <form action="php/ativar/ativarCategoria" method="POST">
              <div class="modal-body text-center">
                <h2 class="fs-3 mb-3">ATENÇÃO</h2>
                <p class="fs-5 m-auto">Você deseja realmente <span class="text-danger">ativar</span> esta Categoria?(produtos devem ser reativados manualmente)</p>
...
<!-- FIM. MODAL ALTERAR -->
      <div class="modal fade" data-bs-backdrop="static" id="alterar" tabindex="-1" aria-labelledby="alterarLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              <h2 class="modal-title fs-4" id="alterarLabel">Alterar Categoria</h2>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
              <form action="php/Alterar/alterarCategoria" method="POST"> 
                <div class="modal-body">
                <input type='text' id='alterarCategoria' value='' hidden name='id'>
                  <div class="col-sm-12">
                      <label for="nome" class="form-label">Nome</label>
                      <input type="text" class="form-control" required name="nome" id="nomeCategoria" placeholder="Nome">
                  </div>
                </div>
                <div class="modal-footer">
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <form action="php/Cadastrar/cadastrarCategoria" method="POST"> 
                <div class="modal-body">
                  <div class="col-12">
                      <label for="nome" class="form-label">Nome</label>
                      <input type="text" class="form-control" required value='<?php echo $nome?>'
                      name="nome" id="nomeCategoria" placeholder="Nome">
                  </div>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Fechar</button>
