...
<html lang="pt-br">
  <head>
    ...
    <title>BeauTIful - Recuperar senha</title>
  </head>
  <body>
    <header>
        <div class="container">
        ...
        <div class="container px-0 px-md-3  my-5">
            ...
            <div class="p-2 p-md-5 mx-auto cardLCD  bg-white border rounded-3 rounded-sm-0"> 
                <div class="pt-3 pt-md-0 text-center">
                    ...
                    <p>Para validar sua identidade, um código de verificação foi enviado</p>
                </div>
                <div class="d-block-flex justify-content-center align-items-center m-2 m-md-4">
                    <form method='post' action='php/conferir.php'>
                    <div class="form-floating">
                        <input type="text" class="form-control" name="codigo" id="codigoRecupera" placeholder="Código">
                        <label for="codigoRecupera">Inserir código</label>
                    </div>
                </div>
                <div class="d-flex justify-content-between align-items-center pb-3 pb-md-0 mx-md-4 mt-4 mt-md-0 me-2">
                    <a href="recuperar.php" class="text-primary">Voltar</a>
                        <button type="submit" class="btn btn-primary px-4">
                            <p class="m-0">Próximo</p>
                        </button>
                </div>
</form>
            </div>
