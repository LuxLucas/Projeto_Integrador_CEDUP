...
<html lang="pt-br">
  ...
  <header>
    ...
    <main>
         ...
         <hr>
          <div class="input-group d-flex justify-content-end">
            <button type="button" class="btn btn-sm btn-primary d-flex me-1" id="btnCadastro" data-bs-toggle='modal' data-bs-target='#cadastro'>
              <p class="me-1 my-1">Cadastrar Estado <i class="ms-1 fs-5 bi bi-plus-square"></i></p>
            </button>
          </div>
         <hr>
        ...
        <!-- TABELA -->
                <table id='estado' class="table table-striped nowrap">
                  <thead>
                      <tr>
                          <th>ID</th>
                          <th>NOME</th>
    ...
    <div class="modal-content">
      ...
      <form action="php/excluirCategoria.php" method="POST">
