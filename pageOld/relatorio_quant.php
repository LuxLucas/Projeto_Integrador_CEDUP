    ...
    <main>
        ...
        <!-- CONTAINER ENDEREÇO CABEÇA -->
                <div class="endereco-head d-flex justify-content-between mb-2">
                  ...
                  <button type="button" class="btn btn-success me-1"><a href="relatorio_preco.php">Por Preço</a></button>
                </div>
        ...
        <!-- TABELA -->
                <table id='relatorio' class="table table-striped table-bordered nowrap">
                  <thead>
                    <tr>
                        <th>ID</th>
                        <th>IMAGEM</th>
                  ...
                  <tbody>
                    <tr class="align-middle text-center">
                        <td>1</td>
                        <td>
                          <div class="img-list d-flex m-auto">
                        ...
                        <td>7,40</td>
                        <td>178</td>
                        <td><button type="button" class="btn"><i class="bi bi-file-earmark-text-fill btnIcon"></i></button></td>
                    </tr>
                    <tr class="align-middle text-center">
                        <td>1</td>
                        <td>
                        ...
                        <td>7,40</td>
                        <td>178</td>
                        <td><button type="button" class="btn"><i class="bi bi-file-earmark-text-fill"></i></button></td>
                    </tr>
                  </tbody>
                </table>
              </div>
