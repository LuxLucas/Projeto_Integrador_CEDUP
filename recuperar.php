        ...
        <div class="container px-0 px-md-3  my-5">
            ...
            <div class="p-2 p-md-5 mx-auto cardLCD  bg-white border rounded-3 rounded-sm-0"> 
                <div class="pt-3 pt-md-0 text-center">
                    ...
                    <p>Digite seu e-mail para realizar a recuperação.</p>
                </div>
                <div class="d-block-flex justify-content-center align-items-center m-2 m-md-4">
                    <div class="form-floating">
                        <form method='post' action='php/enviar.php'>
                        <label for="emailRecupera">E-mail</label>
                        <input type="email" class="form-control" id="emailRecupera" name='email' placeholder="Email">
                    </div>
                </div>
                <div class="d-flex justify-content-between pb-3 pb-md-0 mx-md-4 mt-4 mt-md-0 mx-2">
                    <a href="login.php" class="my-auto text-primary">Voltar</a>
